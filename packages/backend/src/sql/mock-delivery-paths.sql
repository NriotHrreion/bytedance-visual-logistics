...
VALUES 
  ('rAdC12', '2025-11-16 00:00:00', ROW(118.78221974, 32.07915573), '订单已创建', NULL),
  ('rAdC12', '2025-11-17 00:00:00', ROW(118.78221974, 32.07915573), '已发货', NULL);

INSERT INTO delivery_paths (order_id, time, location, action, claim_code)
VALUES 
  ('RktE73', '2025-11-16 00:00:00', ROW(121.42653336, 29.86982248), '订单已创建', NULL),
...
INSERT INTO delivery_paths (order_id, time, location, action, claim_code)
VALUES 
  ('bS2rQ5', '2025-11-16 00:00:00', ROW(121.42653336, 29.86982248), '订单已创建', NULL),
...
INSERT INTO delivery_paths (order_id, time, location, action, claim_code)
VALUES 
  ('e4Tr89', '2025-11-16 00:00:00', ROW(121.42653336, 29.86982248), '订单已创建', NULL),
